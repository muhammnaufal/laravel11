                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                        action="{{ route('admin.jadwal.destroy', $data_jadwal->id) }}" method="POST">
                                        <a href="{{ route('admin.jadwal.show', $data_jadwal->id) }}"
                                            class="btn btn-sm btn-dark tooltip-test" title="Tooltip">SHOW</a>
                                        <a href="{{ route('admin.jadwal.edit', $data_jadwal->id) }}"
