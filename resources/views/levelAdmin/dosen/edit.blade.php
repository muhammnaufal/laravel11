                ...
                <div class="card-body p-0">
                    <form action="{{ route('admin.dosen.update', $dosen->nidn) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nidn" class="form-control" id="exampleInputEmail1"
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <input class="form-control-input" value="L"
                                {{ $dosen->jenis_kelamin == 'L' ? 'checked' : '' }} type="radio" name="jenis_kelamin"
                                id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Laki-Laki
                            </label>
                            <input class="form-control-input" value="P"
                                {{ $dosen->jenis_kelamin == 'P' ? 'checked' : '' }} type="radio" name="jenis_kelamin"
                                id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Perempuan
                            </label>
