                    ...
                    <form action="{{ route('admin.mahasiswa.update', $mahasiswa->nim) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nim" class="form-control" id="exampleInputEmail1"
                                value="{{ old('nim', $mahasiswa->nim) }}" placeholder="Enter NIM">
                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone
                                else.</small>
                            @error('nim')
                                <div class="alert alert-danger mt-2">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control-input" value="L"
                                {{ $mahasiswa->jenis_kelamin == 'L' ? 'checked' : '' }} type="radio" name="jenis_kelamin"
                                id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Laki-Laki
                            </label>
                            <input class="form-control-input" value="P"
                                {{ $mahasiswa->jenis_kelamin == 'P' ? 'checked' : '' }} type="radio" name="jenis_kelamin"
                                id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Perempuan
                            </label>
