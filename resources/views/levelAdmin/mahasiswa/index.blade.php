                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                            action="{{ route('admin.mahasiswa.destroy', $data_mahasiswa->nim) }}"
                                            method="POST">
                                            <a href="{{ route('admin.mahasiswa.show', $data_mahasiswa->nim) }}"
                                                class="btn btn-sm btn-dark">SHOW</a>
                                            <a href="{{ route('admin.mahasiswa.edit', $data_mahasiswa->nim) }}"
